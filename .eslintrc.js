...
const stylisticRules = {
  ...
  indent: ['error', 2, { ignoredNodes: ['TemplateLiteral *', 'TSTypeParameterInstantiation'], SwitchCase: 1 }],
  'key-spacing': ['error'],
  ...
  'object-curly-newline': [
    'error',
    {
      ...
      ExportDeclaration: { minProperties: 6, consistent: true, multiline: true },
    },
  ],
...
module.exports = {
  ...
  parserOptions: { ecmaVersion: 12, project: './tsconfig.json' },
